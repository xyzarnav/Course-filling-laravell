...
<body>
    ...
    <section class="py-3 py-md-5" style="margin-top: -3rem; margin-left: -1rem; background-color: transparent;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-sm-10 col-md-8 col-lg-10 col-xl-5 col-xxl-4">
